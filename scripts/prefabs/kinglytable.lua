...
local function fn(Sim)
    ...
    -- Override swap_object symbol from vanilla table
    inst.AnimState:OverrideSymbol("swap_object", "dining_round_table", "swap_object")
    
    -- Ensure the symbol renders above the table
    inst.AnimState:SetSymbolLightOverride("swap_object", 0.7)
    inst.AnimState:SetSymbolSaturation("swap_object", 1)
